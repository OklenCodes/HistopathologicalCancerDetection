...
id_label = pd.read_csv("../Histopathological Cancer Detection Keras//train_labels.csv")
...
IMAGE_SHAPE = (96, 96, 3)
path_train = "../Histopathological Cancer Detection Keras//train"
batch_size = 32
...
fit_params = {
    ...
    "steps_per_epoch":4500,#len_train // batch_size,
    "epochs": 10,
    "verbose": 1,
